...
Note, classes of target variables - arousal (1-7) and valence (1-7) - are highly imbalanced and not independent.
...
2. [Notebook](https://github.com/tikhonovpavel/EmoEye/blob/main/separated_networks.ipynb) `separated_networks` - notebook with dataloaders, train-test loops and implemented in pytorch parts of multimodal network
3. [Notebook](https://github.com/tikhonovpavel/EmoEye/blob/main/augmentations.ipynb) `augmentations` - notebook to augment Images and Eye-tracking data at once. We didn't have time to train with augmentations, but it works!
